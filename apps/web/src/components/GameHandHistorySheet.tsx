  ...
  return (
    ...
    >
      <motion.div
        ...
        className="w-full max-w-md max-h-[82vh] overflow-y-auto rounded-t-2xl border border-line-strong bg-surface p-4 pb-8"
      >
                  ...
                  >
                    ...
                    <span
                      className={`shrink-0 rounded-full px-2.5 py-1 text-[12px] font-black tabular-nums ${
                        win ? "bg-mint-500/10 text-mint-600" : lose ? "bg-crimson-500/10 text-crimson-600" : "bg-n-2 text-fg-2"
                      }`}
                    >
