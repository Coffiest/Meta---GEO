    ...
    >
      <div className="w-full max-w-sm">
        ...
        >
          ...
          <p
            className={`mt-2 flex items-center justify-center font-black leading-[0.9] tracking-tight text-ink-950 ${
          ...
          >
            {!useRatio && pos != null ? (
              ...
              <>
                <DigitRoll value={pos} fontSize={88} fontWeight={900} textColor="#0a0a0a" gap={0} />
