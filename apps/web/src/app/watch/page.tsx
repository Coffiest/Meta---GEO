  ...
  return (
    <div className="min-h-screen bg-canvas text-fg">
      <div className="mx-auto w-full max-w-2xl px-6 pb-16 pt-[calc(env(safe-area-inset-top)+28px)]">
        ...
        <p className="mt-3 text-[13.5px] leading-relaxed text-n-9">
        ...
        {!loaded ? (
          ...
          >
            {live.isFinalTable && (
              <div className="rounded-2xl border-[1.5px] border-accent bg-accent/10 px-4 py-3 text-center text-[13px] font-black text-fg">
                {t("watch.finalTable")}
              </div>
            )}
        ...
        <p className="mt-8 text-center text-[11px] leading-relaxed text-fg-3">{t("watch.fairnessNote")}</p>
        <p className="mt-4 text-center text-[11px] tracking-wide text-fg-3">
