...
/**
 * トーナメント棋譜解析(chess.comのGame Review準拠)。
 *   1. 総括画面: GTOスコア / 総ロスEV / 分類カウント表 / ワースト・ベストのハイライト
 *   2. 「棋譜解析を開始」→ トナメ全体をテーブル上で1アクションずつ通し再生
 * ハンド一覧ページは廃止(確定仕様)。
 */
        ...
        {loading ? (
          ...
          <>
            ...
            <motion.div
              ...
              className="rounded-2xl border border-ink-950 bg-white p-4 mb-3"
            >
            ...
            <motion.div
              ...
              className="rounded-2xl border border-ink-200 bg-white p-3.5 mb-3"
            >
