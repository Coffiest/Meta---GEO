...
/**
 * 管理者画面。ログイン画面最下部のバージョン表記→パスコード(2357)から到達する。
 * プレイヤー名/メールで検索し、任意ユーザーへ棋譜解析 使い放題プランを無料付与できる
 * (1週間/1ヶ月のプリセット + 任意のN週間/Nヶ月)。付与はサーバー側でも同じパスコードを検証する。
 */
      ...
      <div className="mx-auto max-w-md px-4 pb-24">
        <header className="flex items-center justify-between pt-[calc(env(safe-area-inset-top)+16px)] pb-4">
          <div>
            ...
            <h1 className="text-xl font-black tracking-tight text-ink-950">サブスク管理</h1>
          </div>
